...
url = 'https://gearatlas.com/compare-gear/womens_multiday_backpack'
...
for item in gear_table.find_all('tbody'):
    ...
    for row in rows:
        ...
        frameType = row.find_all('td')[7].text.strip()


        print(mainTitle + ', ' + subTitle + ', ' + msrp + ', ' + weight + ', ' + capacity + ', ' + recomWeight + ', ' + frameType)
